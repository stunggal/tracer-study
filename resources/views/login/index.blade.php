                    ...
                    <div class="d-flex justify-content-center py-4">
                        <a href="index.html" class="logo d-flex align-items-center w-auto">
                            <img src="http://baak.unida.gontor.ac.id/wp-content/uploads/2020/08/cropped-LOGO-UNIDA-FINAL.png"
                                alt="">
                            <span class="d-none d-lg-block">Unida Tracer Study</span>
                        </a>
                    </div><!-- End Logo -->
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="pt-4 pb-2">
                                ...
                                <p class="text-center small">Enter your student email & password to login</p>
                            </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group has-validation">
                                        ...
                                        <input type="email" name="username" class="form-control" id="yourUsername"
                                            required>
                                        <div class="invalid-feedback">Please enter your student email.</div>
                                    </div>
                                </div>
