...
<head>
    ...
    <title>{{ $title }} - Unida Tracer Study</title>
...
<body>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="/profile/show">
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>Tracer Study</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
            Created by <a href="https://bootstrapmade.com/">PPTIK UNIDA Gontor</a>
        </div>
    </footer><!-- End Footer -->
