                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group has-validation">
                                                            <input type="text" class="form-control" id="deskripsi"
                                                                aria-describedby="inputGroupPrepend" name="deskripsi">
                                                            <div class="invalid-feedback">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                                            ...
                                                            @if ($jawaban->pertanyaan_id == $pertanyaan->id)
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        id="gridCheck1" value="{{ $jawaban->jawaban }}">
                                                                    <label class="form-check-label" for="gridCheck1">
                                                                        {{ $jawaban->jawaban }}
                                                                    </label>
                                                                    <form action="/jawaban/delete/{{ $jawaban->id }}"
                                                                        method="post">
                                                                        @csrf
                                                                        <button class="badge btn-danger"><a type="submit"
                                                                                class="badge btn-danger">Delete</a></button>
                                                                    </form>
                                                                </div>
                                                            @endif
                                                        @endforeach
                                            ...
                                            <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal"
                                                data-bs-target="#inputJawaban{{ $pertanyaan->id }}">
                                                Jawaban
                                            </button>
                                            ...
                                            <div class="modal fade" id="editPertanyaan{{ $pertanyaan->id }}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="/pertanyaan/update/{{ $pertanyaan->id }}"
                                                            method="post">
                                                            @csrf
                                                            <div class="modal-body">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="input-group has-validation">
                                                                        <input type="number" class="form-control"
                                                                            ...
                                                                            aria-describedby="inputGroupPrepend"
                                                                            name="nomor"
                                                                            value="{{ $pertanyaan->nomor }}" required>
                                                                        <div class="invalid-feedback">
                                                                            mohon untuk memasukkan nomor.
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="input-group has-validation">
                                                                        <input type="number" class="form-control"
                                                                            ...
                                                                            aria-describedby="inputGroupPrepend"
                                                                            name="section"
                                                                            value="{{ $pertanyaan->section }}" required>
                                                                        <div class="invalid-feedback">
                                                                            mohon untuk memasukkan section.
                                                                        </div>
                                                                    </div>
                                ...
                                @foreach ($pertanyaansSection2 as $pertanyaan)
                                    <div class="card">
                                        <div class="card-body">
                                ...
                                @foreach ($pertanyaansSection3 as $pertanyaan)
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title">{{ $pertanyaan->nomor }}.
                                                {{ $pertanyaan->pertanyaan }}
